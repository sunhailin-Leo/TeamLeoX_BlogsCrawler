...
class LSTMOCR(object):
    def __init__(self, mode):
        ...
        # ctc_loss 需要的是稀疏矩阵
        self.labels = tf.compat.v1.sparse_placeholder(tf.int32)
        # 一维数组，大小[batch_size]
    ...
    def _build_train_op(self):
        ...
        self.loss = tf.compat.v1.nn.ctc_loss(
            labels=self.labels, inputs=self.logits, sequence_length=self.seq_len
        )
